...
export const Categories = (): React.ReactElement => {
  ...
  return (
    <div className="w-full max-w-[92vw] lg:max-w-none flex flex-col gap-6">
      <Navbar className='sticky'>
        ...
        <NavbarItem className={`${selected == 'mcp' && 'opacity-100'}`} onClick={() => setSelected('mcp')}>{t("MCP")}</NavbarItem>
