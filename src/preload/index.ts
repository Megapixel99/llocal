...
const api = {
  ...
  mcpListTools: (servers: object[]): Promise<object[]> => ipcRenderer.invoke('mcp:list-tools', servers),
  mcpCallTool: (servers: object[], name: string, args: object): Promise<string> => ipcRenderer.invoke('mcp:call-tool', servers, name, args),
